...
To install the chart with the release name `workflow-service`:

```console
$ helm repo add c7n https://openchart.choerodon.com.cn/choerodon/c7n
$ helm repo update
$ helm install workflow-service c7n/workflow-service
```
...
| containerPort.actuatorPort | int | `8066` | server management port |
| containerPort.serverPort | int | `8065` | server port |
...
| extraEnv.HWKF_WEB_DOMAIN_NAME | string | `"http://example.com"` |  |
...
| extraEnv.SPRING_DATASOURCE_URL | string | `"jdbc:mysql://localhost:3306/workflow_service?useUnicode=true&characterEncoding=utf-8&useSSL=false?useUnicode=true&characterEncoding=utf-8&useSSL=false&useInformationSchema=true&remarks=true&serverTimezone=Asia/Shanghai"` |  |
...
| image.repository | string | `"c7n/workflow-service"` | service image repository |
...
| initDatabases.datasources.message.driver | string | `"com.mysql.jdbc.Driver"` |  |
| initDatabases.datasources.message.password | string | `"password"` |  |
| initDatabases.datasources.message.url | string | `"jdbc:mysql://localhost:3306/?useUnicode=true&characterEncoding=utf-8&useSSL=false&useInformationSchema=true&remarks=true&serverTimezone=Asia/Shanghai"` |  |
| initDatabases.datasources.message.username | string | `"username"` |  |
...
| service.nodePort | object | `{"actuator":30131,"server":30130}` | Specify the nodePort value for the LoadBalancer and NodePort service types. |
| service.port | object | `{"actuator":8066,"server":8065}` | server Service port |
