...
databaseChangeLog(logicalFilePath: 'script/db/hwkf_run_exception_arch.groovy') {
    ...
    changeSet(author: "like.zhang@hand-china.com", id: "2021-02-01-hwkf_run_exception_arch") {
        dropNotNullConstraint(tableName: 'hwkf_run_exception_arch', columnName: 'RUN_NODE_ID', columnDataType: 'bigint')
    }
}