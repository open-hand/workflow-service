...
databaseChangeLog(logicalFilePath: 'script/db/hwkf_run_assignee.groovy') {
    changeSet(author: "xiuhong.chen@hand-china.com", id: "2021-05-08-hwkf_run_assignee") {
        def weight = 1
        ...
        if (helper.dbType().isSupportSequence()) {
            createSequence(sequenceName: 'hwkf_run_assignee_s', startValue: "1")
        }
        createTable(tableName: "hwkf_run_assignee", remarks: "处理人表") {
        ...
        createIndex(tableName: "hwkf_run_assignee", indexName: "hwkf_run_assignee_N1") {
            column(name: "INSTANCE_ID")
        }
        createIndex(tableName: "hwkf_run_assignee", indexName: "hwkf_run_assignee_N2") {
            column(name: "NODE_ID")
        }
        createIndex(tableName: "hwkf_run_assignee", indexName: "hwkf_run_assignee_N3") {
            column(name: "TASK_ID")
        }
    }
}
