...
databaseChangeLog(logicalFilePath: 'script/db/hwkf_run_assignee_his_arch.groovy') {
    changeSet(author: "xiuhong.chen@hand-china.com", id: "2021-08-30-hwkf_run_assignee_his_arch") {
        def weight = 1
        ...
        if (helper.dbType().isSupportSequence()) {
            createSequence(sequenceName: 'hwkf_run_assignee_his_arch_s', startValue: "1")
        }
        createTable(tableName: "hwkf_run_assignee_his_arch", remarks: "处理人表") {
        ...
        createIndex(tableName: "hwkf_run_assignee_his_arch", indexName: "hwkf_run_assignee_his_arch_N1") {
            column(name: "INSTANCE_ID")
        }
        createIndex(tableName: "hwkf_run_assignee_his_arch", indexName: "hwkf_run_assignee_his_arch_N2") {
            column(name: "NODE_ID")
        }
        createIndex(tableName: "hwkf_run_assignee_his_arch", indexName: "hwkf_run_assignee_his_arch_N3") {
            column(name: "TASK_ID")
        }
    }
}
