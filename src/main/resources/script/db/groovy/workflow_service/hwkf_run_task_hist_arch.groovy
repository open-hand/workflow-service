...
databaseChangeLog(logicalFilePath: 'script/db/hwkf_run_task_hist_arch.groovy') {
    changeSet(author: "weisen.yang@hand-china.com", id: "2021-01-27-hwkf_run_task_hist_arch") {
        def weight = 1
        ...
        if (helper.dbType().isSupportSequence()) {
            createSequence(sequenceName: 'hwkf_run_task_hist_arch_s', startValue: "1")
        }
        createTable(tableName: "hwkf_run_task_hist_arch", remarks: "流程节点任务归档表") {
            column(name: "TASK_HISTORY_ARCH_ID", type: "bigint", autoIncrement: true, remarks: "表ID，主键，供其他表做外键") { constraints(primaryKey: true) }
            column(name: "TASK_HISTORY_ID", type: "bigint", remarks: "流程节点历史ID，hwkf_run_task_history主键") { constraints(nullable: "false") }
            ...
            column(name: "PARENT_NODE_ID", type: "bigint", remarks: "父节点ID、查找上一节点使用")
            ...
            column(name: "TO_PERSON", type: "varchar(" + 240 * weight + ")", remarks: "转交人加签人")
        ...
        createIndex(tableName: "hwkf_run_task_hist_arch", indexName: "hwkf_run_task_hist_arch_N3") {
            column(name: "NODE_ID")
        }
        createIndex(tableName: "hwkf_run_task_hist_arch", indexName: "hwkf_run_task_hist_arch_N1") {
            column(name: "INSTANCE_ID")
        }
        createIndex(tableName: "hwkf_run_task_hist_arch", indexName: "hwkf_run_task_hist_arch_N2") {
