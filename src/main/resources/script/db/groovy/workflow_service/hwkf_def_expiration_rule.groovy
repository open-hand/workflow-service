...
databaseChangeLog(logicalFilePath: 'script/db/hwkf_def_expiration_rule.groovy') {
    ...
    changeSet(author: "like.zhang@hand-china.com", id: "2021-02-01-hwkf_def_expiration_rule") {
        addColumn(tableName: 'hwkf_def_expiration_rule') {
            column(name: "EXPIRATION_TIME_TEMP", type: "decimal(20,2)", remarks: "超时时间")
        }
        sql("UPDATE hwkf_def_expiration_rule SET EXPIRATION_TIME_TEMP = EXPIRATION_TIME")
        dropColumn(tableName: 'hwkf_def_expiration_rule', columnName: 'EXPIRATION_TIME')
        renameColumn(tableName: "hwkf_def_expiration_rule", newColumnName: "EXPIRATION_TIME", oldColumnName: "EXPIRATION_TIME_TEMP", columnDataType: "decimal(20,2)", remarks: "超时时间")
