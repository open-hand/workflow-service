...
databaseChangeLog(logicalFilePath: 'script/db/hwkf_run_variable_history.groovy') {
    changeSet(author: "weisen.yang@hand-china.com", id: "2021-01-27-hwkf_run_variable_history") {
        def weight = 1
        ...
        if (helper.dbType().isSupportSequence()) {
            createSequence(sequenceName: 'hwkf_run_variable_history_s', startValue: "1")
        }
        createTable(tableName: "hwkf_run_variable_history", remarks: "历史流程变量表") {
        ...
        createIndex(tableName: "hwkf_run_variable_history", indexName: "hwkf_run_variable_history_N3") {
            column(name: "TASK_ID")
        }
        createIndex(tableName: "hwkf_run_variable_history", indexName: "hwkf_run_variable_history_N2") {
            column(name: "NODE_ID")
        }
        createIndex(tableName: "hwkf_run_variable_history", indexName: "hwkf_run_variable_history_N1") {
