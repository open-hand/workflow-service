...
public class PersonalTodoC7nRepositoryImpl implements PersonalTodoC7nRepository {
    ...
    public List<PersonalTodoViewDTO> selectPersonalTodo(Long tenantId, PersonalTodoQueryDTO queryDTO, List<Long> backlogIds) {
        ...
        List<PersonalTodoViewDTO> result = this.personalTodoC7nMapper.selectPersonalTodo(queryDTO,backlogIds);
    ...
    public List<PersonalTodoViewDTO> selectMobilePersonalTask(PersonalTodoQueryDTO queryDTO, List<Long> backlogIds) {
        List<PersonalTodoViewDTO> result = this.personalTodoC7nMapper.selectPersonalTask(queryDTO,backlogIds);
    ...
    public List<ParticipatedDTO> selectMineParticipated(Long tenantId, PersonalTodoQueryDTO queryDTO, List<Long> backlogIds) {
        ...
        String self = this.userUtils.selfConfirm(queryDTO.getSelf());
        queryDTO.setSelf(self);
        List<ParticipatedDTO> result = this.personalTodoC7nMapper.selectMineParticipated(queryDTO, backlogIds);
        this.processExtraFields(result, tenantId, self, queryDTO.getSeparator());
        return result;
    }
    ...
    public List<SubmittedDTO> selectMineSubmitted(Long tenantId, PersonalTodoQueryDTO queryDTO, List<Long> backlogIds) {
        ...
        String self = this.userUtils.selfConfirm(queryDTO.getSelf());
        queryDTO.setSelf(self);
        List<SubmittedDTO> result = this.personalTodoC7nMapper.selectMineSubmitted(queryDTO, backlogIds);
        this.processExtraFields(result, tenantId, self, queryDTO.getSeparator());
    ...
    public List<CarbonCopyDTO> selectMineCarbonCopied(Long tenantId, PersonalTodoQueryDTO queryDTO, List<Long> backlogIds) {
        ...
        String self = this.userUtils.selfConfirm(queryDTO.getSelf());
        queryDTO.setSelf(self);
        List<CarbonCopyDTO> result = this.personalTodoC7nMapper.selectMineCarbonCopied(queryDTO,backlogIds);
        this.processExtraFields(result, tenantId, self, queryDTO.getSeparator());
        return result;
    }
    ...
    public List<BaseViewDTO> selectSubProcess(PersonalTodoQueryDTO queryDTO, List<Long> backlogIds) {
        String self = this.userUtils.selfConfirm(queryDTO.getSelf());
        queryDTO.setSelf(self);
        List<BaseViewDTO> baseViewDTOS = this.personalTodoC7nMapper.selectSubProcess(queryDTO,backlogIds);
